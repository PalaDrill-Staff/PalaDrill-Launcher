 ...
 */
function dont_resolveDropinModsForUI(){
 ...
 */
function undo_bindDropinModsRemoveButton(){
 ...
 */
function undo_bindDropinModFileSystemButton(){
 ...
 */
function undo_saveDropinModConfiguration(){
    for(dropin of CACHE_DROPIN_MODS){
...
function dont_reloadDropinMods(){
...
function eee_saveShaderpackSettings(){
    let sel = 'OFF'
 ...
 */
function undoçprepareModsTab(first){
    resolveModsForUI()
    resolveShaderpacksForUI()
